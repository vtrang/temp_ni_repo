...
function fnNovaInitia_injectToolbar() {
   ...
   $("#niTBC").html('<div id="toolbarWrapper"><div id="toolbar_login" style="display: none"><table cellspacing="0" cellpadding="0" id="toolbarTable"><tr><td class="toolbarItem"><img id="nova_initia_tool_login" class="nova_initia_tools_toolbarbutton" onclick="niClientApp_login();" src="http://mikederoche.com/cs320/commoncode/skin/images/login48.png" /> Login</td></tr></table></div><div id="toolbar"><table cellspacing="0" cellpadding="0" id="toolbarTable"><tr><td class="toolbarItem"><img id="nova_initia_tool_trap" class="nova_initia_tools_toolbarbutton" onclick="window.NovaInitia.Toolbar.process_toolbutton(this,null);" src="http://mikederoche.com/cs320/commoncode/skin/images/cog32.png" /><div id="novaInitia_toolbar_inventory_traps">--</div></td><td class="toolbarItem"><img id="nova_initia_tool_barrel" class="nova_initia_tools_toolbarbutton" onclick="niClientApp_catchPopup(this.id);" src="http://mikederoche.com/cs320/commoncode/skin/images/bar32.png" /><div id="novaInitia_toolbar_inventory_barrells">--</div></td><td class="toolbarItem"><img id="nova_initia_tool_signpost" class="nova_initia_tools_toolbarbutton" onclick="niClientApp_catchPopup(this.id);" src="http://mikederoche.com/cs320/commoncode/skin/images/sign32.png" /><div id="novaInitia_toolbar_inventory_signposts">--</div></td><td class="toolbarItem"><img id="nova_initia_tool_doorway" class="nova_initia_tools_toolbarbutton" onclick="niClientApp_catchPopup(this.id);" src="http://mikederoche.com/cs320/commoncode/skin/images/door32.png" /><div id="novaInitia_toolbar_inventory_doors">--</div></td><td class="toolbarItem"><img id="nova_initia_tool_spider" class="nova_initia_tools_toolbarbutton" onclick="window.NovaInitia.Toolbar.process_toolbutton(this,null);" src="http://mikederoche.com/cs320/commoncode/skin/images/bug32.png" /><div id="novaInitia_toolbar_inventory_spiders">--</div></td><td class="toolbarItem"><img id="nova_initia_tool_shield" class="nova_initia_tools_toolbarbutton" onclick="window.NovaInitia.Toolbar.process_toolbutton(this,null);" src="http://mikederoche.com/cs320/commoncode/skin/images/shieldOn32.png" /><div id="novaInitia_toolbar_inventory_shields">--</div></td><td class="toolbarItem" style="width: 80px"><img id="nova_initia_tool_events" onclick="niClientApp_loadURL(this);" src="http://mikederoche.com/cs320/commoncode/skin/images/events32.png" /> Events</td><td class="toolbarItem" style="width: 65px"><img id="nova_initia_tool_mail" onclick="niClientApp_loadURL(this)" src="http://mikederoche.com/cs320/commoncode/skin/images/msg32.png" /><div id="novaInitia_toolbar_inventory_messages">--</div></td><td class="toolbarItem" style="width: 80px"><img id="nova_initia_tool_profile" onclick="niClientApp_loadURL(this);" src="http://mikederoche.com/cs320/commoncode/skin/images/profile32.png" /> Profile</td><td class="toolbarItem" style="width: auto; text-align: right"><img style="float: none;" id="nova_initia_tool_sg" onclick="niClientApp_loadURL(this)" src="http://mikederoche.com/cs320/commoncode/skin/images/sg32.png" /><div id="novaInitia_toolbar_inventory_sg" style="float: right">--</div></td><td class="toolbarItem" style="width: 50px; padding-right: 5px; padding-left: 20px; text-align: right"><img src="http://mikederoche.com/cs320/commoncode/skin/images/logout32.png" onclick="window.NovaInitia.Toolbar.logout();" /></td></tr></table></div></div>');
   ...
   cssl.setAttribute("href","http://mikederoche.com/cs320/commoncode/skin/nova-initia_toolbar.css");
